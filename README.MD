This folder contains the same information from the flat file in the 'Main' branch refactored into separate modules for networking and server configuration.
